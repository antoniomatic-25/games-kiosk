...
public class Catalogue {
    ...
    public ObservableList<Game> getGamesByYear(IntegerProperty year) {

       ObservableList<Game> gamesByYear = FXCollections.observableArrayList();

        for (Game m : this.getAllGames()) {
            if (m.yearProperty() == year) {
                gamesByYear.add(m);
            }
        }
    ...
    public ObservableList<IntegerProperty> getYears() {
        ObservableList<IntegerProperty> availableYears = FXCollections.observableArrayList();

        for (Game m : this.getAllGames()) {
            IntegerProperty year = m.yearProperty();
